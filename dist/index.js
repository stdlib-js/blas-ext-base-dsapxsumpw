...
var g=require('@stdlib/math-base-special-floor/dist'),k=128;function _(e,r,n,v,o){var u,i,m,c,w,y,j,E,O,C,q,s,f;if(e<=0)return 0;if(e===1||v===0)return r+n[o];if(u=o,e<8){for(q=0,f=0;f<e;f++)q+=r+n[u],u+=v;return q}if(e<=k){for(i=r+n[u],m=r+n[u+v],c=r+n[u+2*v],w=r+n[u+3*v],y=r+n[u+4*v],j=r+n[u+5*v],E=r+n[u+6*v],O=r+n[u+7*v],u+=8*v,C=e%8,f=8;f<e-C;f+=8)i+=r+n[u],m+=r+n[u+v],c+=r+n[u+2*v],w+=r+n[u+3*v],y+=r+n[u+4*v],j+=r+n[u+5*v],E+=r+n[u+6*v],O+=r+n[u+7*v],u+=8*v;for(q=i+m+(c+w)+(y+j+(E+O)),f;f<e;f++)q+=r+n[u],u+=v;return q}return s=g(e/2),s-=s%8,_(s,r,n,v,u)+_(e-s,r,n,v,u+s*v)}I.exports=_
