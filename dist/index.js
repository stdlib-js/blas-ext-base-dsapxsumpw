...
var b=require('@stdlib/math-base-special-floor/dist'),g=128;function O(n,r,e,v,a){var u,q,i,m,c,y,t,w,j,B,f,s,o;if(n<=0)return 0;if(u=a,v===0)return n*(r+e[u]);if(n<8){for(f=0,o=0;o<n;o++)f+=r+e[u],u+=v;return f}if(n<=g){for(q=r+e[u],i=r+e[u+v],m=r+e[u+2*v],c=r+e[u+3*v],y=r+e[u+4*v],t=r+e[u+5*v],w=r+e[u+6*v],j=r+e[u+7*v],u+=8*v,B=n%8,o=8;o<n-B;o+=8)q+=r+e[u],i+=r+e[u+v],m+=r+e[u+2*v],c+=r+e[u+3*v],y+=r+e[u+4*v],t+=r+e[u+5*v],w+=r+e[u+6*v],j+=r+e[u+7*v],u+=8*v;for(f=q+i+(m+c)+(y+t+(w+j)),o;o<n;o++)f+=r+e[u],u+=v;return f}return s=b(n/2),s-=s%8,O(s,r,e,v,u)+O(n-s,r,e,v,u+s*v)}C.exports=O
